...
//This is the Swagger configuration for the API documentation.
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new() { Title = "CricketLeague_Backend", Version = "v1" });
...
// DbContext
builder.Services.AddDbContext<CricketLeagueContext>(options =>
